<?php
    ...
    $id = $_GET["id"];  // obtiene el codigo de la base de datos enviado por medio del boton Editar a traves de get 
            ...
            <div class="container">
                ...
                <div align="center">
                    ...
                    <div class="card-body" align="center">
                        ...
                        <a href="listacli.php" class="btn btn-primary">Aceptar</a>
                    </div>
                </div>
            </div>
        ');
